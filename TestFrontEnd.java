...
public class TestFrontend {
        ...
        public void runTests() {
                ...
                System.out.print("Test 'r' load rating selection screen (WARNING: if pressing 'x' twice from the rating selection screen does not exit app, test won't exit and run indefinitely!): ");
                if (this.testDeselectForRatings()) {
                        System.out.println("PASSED");
                } else {
                        System.out.println("FAILED");
                }
    ...
    /**                                                                                                                                                                                                     
        ...
        public boolean enterXToExit() {
            ...
            try {
                    ...
                    Object frontend = new Frontend(new Backend(new StringReader(                                                                                                                              
 ...
 * the app by pressing 'x' to go back to the main mode and another 'x' to exit.                                                                                                                    
 * The test succeeds if the rating selection screen contains all three ratings                                                                                                                     
 * from the data. It fails if any of them are missing, the front end has not                                                                                                                       
 * been instantiated (is null), or there is an exception.                                                                                                                                          
 * @return true if the test passed, false if it failed                                                                                                                                             \
 */
public boolean testFrontendRForRatings() {
        ...
        InputStream standardIn = System.in;
        try {
            // set the input stream to our input (with an r to test of the program lists ratings)                                                                                              
...
/**                                                                                                                                                                                                        
* This test runs the front end and redirects its output to a string. It then                                                                                                                      
* passes in 'r' as a command to go to the ratings selection mode. It then exists * the app by pressing 'x' to go back to the main mode and another 'x' to exit.                                                                                                                    \
         * The test succeeds if the rating selection does not contain any of the three ratings                                                                                                             \
         * after deselecting them. It fails if any of them are present, the front end has not                                                                                                               
         * been instantiated (is null), or there is an exception.                                                                                                                                          
         * @return true if the test passed, false if it failed                                                                                                                                             
         */
       public boolean testDeselectForRatings() {
                PrintStream standardOut = System.out;
                InputStream standardIn = System.in;
                try {
                        // set the input stream to our input (with an g to test of the program lists genres)                                                                                                
                        String input = "r" + System.lineSeparator() + "2" + System.lineSeparator() + "3" + System.lineSeparator() + "5" + System.lineSeparator() + "x" + System.lineSeparator() + "x";
                        InputStream inputStreamSimulator = new ByteArrayInputStream(input.getBytes());
                        System.setIn(inputStreamSimulator);
                        ByteArrayOutputStream outputStreamCaptor = new ByteArrayOutputStream();
                        // set the output to the stream captor to read the output of the front end                                                                                                          
